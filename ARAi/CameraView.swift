    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $instruct) {
                OnboardingView(onboardingViews: [Onboarding(id: UUID(), image: "scan", title: "Photo Time!", description: "Take photos of an object with each photo overlapping and from various angles."), Onboarding(id: UUID(), image: "scan", title: "Photo Time!", description: "Ensure that the only object you want scanned is visable to your camera, not any other object."), Onboarding(id: UUID(), image: "scan", title: "Photo Time!", description: "Please allow for plenty of lighting and avoid see through objects."), Onboarding(id: UUID(), image: "scan", title: "Upload Your Photos", description: "Once you've taken at least 20 photos, tap the photo preview in the bottom left, then tap upload and follow the instructions on the next view.")],isOnboarding: $instruct, isOnboarding2: $instruct, userData: userData)
