...
//    
//    public func uploadFile(localFile: URL, serverFileName: String, userID: String, folderName: String, completionHandler: @escaping (_ isSuccess: Bool, _ url: String?) -> Void) {
//        
//        let storage = Storage.storage()
//        let storageRef = storage.reference()
//        // Create a reference to the file you want to upload
//        let directory = "\(userID)/\(folderName)/"
